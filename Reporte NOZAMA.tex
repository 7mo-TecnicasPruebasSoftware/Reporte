...
\begin{enumerate}[label=RN\arabic*:]
    ...
    \item Si un producto tiene simultáneamente una promoción de producto y una promoción de categoría activas, se aplica únicamente el descuento de mayor porcentaje; no se acumulan entre sí ni con el descuento VIP.
...
\begin{tabularx}{\linewidth}{|p{2.5cm}|X|X|X|X|}
    ...
    CU06: Ver detalle de producto            & OE2                     & RF03a, RF03b             & RN14--RN17, RN24--RN27         & RNF03, RNF08            \\ \hline
    ...
    CU09: Realizar pago y confirmar orden    & OE4                     & RF05, RF06               & RN21--RN23, RN24--RN27         & RNF01, RNF07            \\ \hline
    CU10: Consultar historial de órdenes     & OE4                     & RF07                     & RN7, RN8                       & RNF07, RNF08            \\ \hline
    CU11: Gestionar productos                & OE5                     & RF08, RF12               & RN14--RN17, RN28, RN29         & RNF02, RNF05            \\ \hline
    CU12: Gestionar categorías               & OE5                     & RF08                     & RN10--RN13, RN28, RN29         & RNF02, RNF05            \\ \hline
    CU13: Gestionar usuarios                 & OE1, OE5                & RF09, RF10               & RN1, RN3, RN7, RN8, RN28, RN29 & RNF02, RNF05
    \\ \hline
    CU14: Gestionar promociones y descuentos & OE5                     & RF11                     & RN24--RN27, RN28, RN29         & RNF02, RNF05            \\ \hline
\end{tabularx}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth,height=0.7\textheight,keepaspectratio]{landing_page.png}
    \caption{Pagína principal de Nozama}
    \label{fig:dc}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{login_page.png}
    \caption{Pagína de inicio de sesión}
    \label{fig:dc}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{signin_page.png}
    \caption{Pagína de creación de cuenta}
    \label{fig:dc}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{product_page.png}
    \caption{Pagína que muestra detalles del producto}
    \label{fig:dc}
\end{figure}
